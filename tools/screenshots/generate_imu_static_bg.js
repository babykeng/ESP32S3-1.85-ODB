...
const inputPath = process.argv[2] || "/tmp/imu_bg.ppm";
const outputPath = process.argv[3] || path.join(__dirname, "../../components/esp32s3_obd/images/imuStaticBg.c");
...
const rgb = readPpm(inputPath);
const out = [];

out.push("// Auto-generated from LVGL IMU static layer screenshot.\n");
out.push("// Rebuild with tools/screenshots/generate_imu_static_bg.js after IMU static UI changes.\n\n");
...
out.push("#ifndef LV_ATTRIBUTE_IMG_IMUSTATICBG\n#define LV_ATTRIBUTE_IMG_IMUSTATICBG\n#endif\n\n");
out.push("const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_IMUSTATICBG uint8_t imuStaticBg_map[] = {\n");
...
out.push("};\n\n");
out.push("const lv_img_dsc_t imuStaticBg = {\n");
